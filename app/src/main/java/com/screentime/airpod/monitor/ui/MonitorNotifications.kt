package com.screentime.airpod.monitor.ui
...
import com.screentime.airpod.common.notifications.PendingIntentCompat
import com.screentime.airpod.main.ui.MainActivity
...
class MonitorNotifications @Inject constructor(
    ...
    init {
        ...
        builder = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID).apply {
            ...
            setSmallIcon(com.screentime.airpod.common.R.drawable.devic_earbuds_generic_both)
            setOngoing(true)
            setContentTitle(context.getString(com.screentime.airpod.common.R.string.app_name))
        }
    }
    ...
    private fun getBuilder(device: PodDevice?): NotificationCompat.Builder {
        if (device == null) {
            return builder.apply {
                ...
                setContentTitle(context.getString(com.screentime.airpod.common.R.string.pods_none_label_short))
                setSubText(context.getString(com.screentime.airpod.common.R.string.app_name))
                setSmallIcon(com.screentime.airpod.common.R.drawable.devic_earbuds_generic_both)
            }
        }
        ...
        return builder.apply {
            ...
            val stateText = when {
                ...
                device is HasChargeDetection && device.isHeadsetBeingCharged -> {
                    context.getString(com.screentime.airpod.common.R.string.pods_charging_label)
                }

                // Pods wear state
                device is HasEarDetection -> {
                    if (device.isBeingWorn) context.getString(com.screentime.airpod.common.R.string.headset_being_worn_label)
                    else context.getString(com.screentime.airpod.common.R.string.headset_not_being_worn_label)
                }
