package com.screentime.airpod.main.ui.widget
...
import com.screentime.airpod.common.upgrade.isPro
import com.screentime.airpod.main.ui.MainActivity
import com.screentime.airpod.monitor.core.PodDeviceCache
...
class WidgetProvider : AppWidgetProvider() {
    ...
    private fun createUnknownPodLayout(
        ...
        setTextViewText(R.id.primary, context.getString(com.screentime.airpod.common.R.string.pods_unknown_label))
    }
    ...
    private fun createNoDeviceLayout(
        ...
        setTextViewText(R.id.primary, context.getString(com.screentime.airpod.common.R.string.overview_nomaindevice_label))
    }
