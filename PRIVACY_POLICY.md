# Privacy policy
This is the privacy policy for the Android app "AirPods - Companion for AirPods".

## Preamble
AirPods respects your privacy.
...
AirPods does not collect, share or sell location data.
...
AirPods requests location permissions because these permissions are required to work with Bluetooth Low Energy data.
...
AirPods uses the "location access in the background" permission (`ACCESS_BACKGROUND_LOCATION`) on Android 11 and older to
receive Bluetooth Low Energy data while the app is in the background. This permission enables the "Show popup" and "
Autoconnect" features and allows AirPods to react to nearby devices whil the app is closed.
